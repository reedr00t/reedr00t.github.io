...
(function() {
    ...
    var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
    var version_modss = '3.1', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = false, leftVipD = '', user_id = '', uid = 'bb04b81f6297b1b6280ea8273', IP, logged = false, cashe = encodeURIComponent(Lampa.Base64.encode(window.location.origin));
