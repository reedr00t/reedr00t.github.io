(function() {
    ...
    Lampa.Settings.listener.follow('open', function(e) {
        if (e.name == 'main') {
            e.body.find('[data-component="my_store"]').on('hover:enter', function() {
                Lampa.Extensions.show({
                    store: 'https://reedr00t.github.io/store/extensions.json',
                    with_installed: true
                });
            });
        }
