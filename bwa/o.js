(function() {
  ...
  var rchtype = Lampa.Platform.is('android') ? 'apk' : 'cors';
    ...
    this.rch = function(json, noreset) {
      ...
      var load = function load() {
        ...
        hubConnection.start().then(function() {
          hubConnection.invoke("RchRegistry", JSON.stringify({version:136, host:location.host, rchtype: rchtype})).then(function() {
      ...
      if (typeof signalR == 'undefined') {
        Lampa.Utils.putScript(["http://default.rc.bwa.to/signalr-6.0.25_es5.js"], function() {}, false, function() {
          load();
        }, true);
      } else load();
    };
